...
var restrict_option_y = 135;
var restrict_option_w = wrapper_w/4;
var restrict_option_h = 270;
...
function createPlanets(){
    ...
    var planet1 = newPlanet(350 + flagInt, 270 + flagInt, "LV1")
	planets.push(planet1);
	
	//var planet2 = createPlanet(p2b(380), p2b(200), p2b(50), 13, 3.5);
	var planet2 = newPlanet(1280 + flagInt, 270 + flagInt, "LV2")
	planets.push(planet2);

    //var planet3 = createPlanet(p2b(560), p2b(400), p2b(60), 15, 5);
	var planet3 = newPlanet(760 + flagInt, 100 + flagInt, "LV3")
	planets.push(planet3);

	var planet3_1 = newPlanet(1060 + flagInt, 440 + flagInt, "LV3")
	planets.push(planet3_1);

	var planet4 = newPlanet(1450 + flagInt, 135 + flagInt, "LV1")
	planets.push(planet4);

	var planet5 = newPlanet(1450 + flagInt, 270 + flagInt, "LV1")
	planets.push(planet5);

	var planet6 = newPlanet(1450 + flagInt, 405 + flagInt, "LV1")
...
function update() {
	...
	if((x_res >= canvas_w - 15) && ((y_res <= canvas_h) && ( y_res >= 0 ))){
		...
		setTimeout("location.href='../frame/stage.html'",2000);
	}
}
